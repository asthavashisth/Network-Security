...
class DataValidationConfig:
        def __init__(self, training_pipeline_config: TrainingPipelineConfig):
            ...
            self.valid_data_dir: str = os.path.join(
                self.data_validation_dir, training_pipeline.DATA_VALIDATION_VALID_DIR, training_pipeline.FILE_NAME
            )
            self.invalid_data_dir: str = os.path.join(
                self.data_validation_dir, training_pipeline.DATA_VALIDATION_INVALID_DIR, training_pipeline.FILE_NAME
            )
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.transformed_train_file_path: str = os.path.join(
            ...
            os.path.splitext(training_pipeline.TRAIN_FILE_NAME)[0] + ".npy"
        )
        self.transformed_test_file_path: str = os.path.join(
            self.data_transformation_dir,
            training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            os.path.splitext(training_pipeline.TEST_FILE_NAME)[0] + ".npy"
        )
